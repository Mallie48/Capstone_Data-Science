...
library(data.table)
#load("C:/Data Science/Capstone/myApp/divideNGram.RData")
load("./divideNGram.RData")

#dataIn <- fread("C:/Data Science/Capstone/myApp/NGramSortedFinal.txt", sep = "\t", header=TRUE, data.table = FALSE)
...
#source('C:/Data Science/Capstone/myApp/getPredWord.R')
